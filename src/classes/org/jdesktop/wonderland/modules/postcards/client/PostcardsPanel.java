...
public class PostcardsPanel extends javax.swing.JPanel {
    ...
    private ImagePanel viewImagePanel = null;
    ...
    //    public void setCaptureImage(final BufferedImage image) {
...
//                logger.severe("graphics " + (image != null));
...
//    }
    public void setCaptureImage(final BufferedImage image) {
        ...
        SwingUtilities.invokeLater(new Runnable() {
            ...
            public void run() {
                if(viewImagePanel != null) {
                    shootPanel.remove(viewImagePanel);
                }
                Graphics g = viewImage.getGraphics();
                logger.severe("graphics " + (image != null));
//                g.drawImage(image,0,0,null);
                viewImagePanel = new ImagePanel(image);
                shootPanel.add(viewImagePanel);
//                shootPanel.paint(g);
                shootPanel.repaint();
    ...
    private void initComponents() {
        ...
        shootPanel = new javax.swing.JPanel() {
            ...
            public void paintComponent(Graphics g) {
                logger.severe("in paint - g " + (g != null));
                super.paintComponent(g);
                if (viewImage != null) {

                    g.setColor(Color.BLACK);
                    boolean test = g.drawImage(viewImage, 0, 0, null);
                    logger.severe("return from drawImage " + test);
...
//if (viewImage != null){
        ...
        g.setColor(Color.BLACK);
        boolean test = g.drawImage(img, 0, 0, null);
//logger.severe("return from drawImage " + test);
